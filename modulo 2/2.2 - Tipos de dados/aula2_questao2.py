...
print("Variável:", resultado, ", e o seu tipo: ", type(resultado))
print("Variável:", n1, ", e o seu tipo: ", type(n1))
print("Variável:", n2, ", e o seu tipo: ", type(n2))
print("Variável:", soma, ", e o seu tipo: ", type(soma))